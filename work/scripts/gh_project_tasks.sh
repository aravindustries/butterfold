...
#
# Usage:
#   work/scripts/gh_project_tasks.sh               # Hermes-tagged tasks only
#   work/scripts/gh_project_tasks.sh --all         # every task on the board
#   work/scripts/gh_project_tasks.sh --json        # Hermes-tagged as JSON
#   work/scripts/gh_project_tasks.sh --all --json  # every task as JSON
#
# Board identity can be overridden via:
#   BUTTERFOLD_PROJECT=4 BUTTERFOLD_OWNER=Eloquencere work/scripts/gh_project_tasks.sh
set -euo pipefail
