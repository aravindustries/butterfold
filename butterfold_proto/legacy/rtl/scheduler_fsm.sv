...
module scheduler #(
    ...
    // FFT128 twiddle ROM
    //
    // Entries contain W_128^k = exp(-j*2*pi*k/128), k=0..63, in Q1.7.
    // Index zero is overridden by the exact-unity proxy described above.
    //==========================================================================
    ...
    //==========================================================================
    // FFT128 folded scheduling state
    //==========================================================================
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (rx_state == RX_COMMAND && din_fire && din == CMD_FFT128) begin
    ...
    always @(posedge clk) begin
        if (fft128_input_write) begin
            ...
            fft_ram_i[fft128_addr0] <= bf_X0_i;
            fft_ram_q[fft128_addr0] <= bf_X0_q;
            fft_ram_i[fft128_addr1] <= bf_X1_i;
            fft_ram_q[fft128_addr1] <= bf_X1_q;
        end
    end
