# Native DRT + post-DRT antenna loop after second electrical pass.
...
detailed_route -droute_end_iter 64 -or_seed 42 -verbose 1 \
  -output_drc $out/drt2/drt-run-${i}.drc
puts "DRT_RUNTIME_MS_$i [expr {[clock milliseconds]-$t0}]"
write_db $out/drt2/drt-run-${i}.odb
incr i
...
check_antennas -verbose -report_file $out/antenna/final2_verbose.rpt
