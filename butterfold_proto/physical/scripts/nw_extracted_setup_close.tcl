# =============================================================================
# North/West pin-placement extracted-aware setup ECO
# =============================================================================
...
# SS liberty only for setup. Then legalize, GRT+DRT, re-extract.
#
# Usage (from butterfold_proto):
#   ECO_SRC=... ECO_OUTDIR=... openroad -no_init -exit physical/scripts/nw_extracted_setup_close.tcl
# =============================================================================

set script_dir [file dirname [file normalize [info script]]]
set proto_root [file normalize [file join $script_dir .. ..]]
set pdk /foss/pdks/gf180mcuD
set run $proto_root/physical/librelane/runs/butterfold_top_nw_pins_38p4_9t
...
if {![info exists env(ECO_OUTDIR)] || $env(ECO_OUTDIR) eq ""} {
  set outdir $proto_root/physical/results/nw_pins_eco
} else {
