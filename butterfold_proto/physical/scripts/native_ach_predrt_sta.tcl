# OpenRCX extract + SPEF STA for the pre-DRT timing-repair candidate.
# Writes ONLY under predrt/. Never overwrites the 80ef23f6 checkpoint SPEF.
...
if {$corner eq "max_ss"} {
  ...
  if {[info exists ::env(FORCE_EXTRACT)] && $::env(FORCE_EXTRACT) eq "1"} {
