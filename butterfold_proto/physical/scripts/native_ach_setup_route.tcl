# Full signal re-route after setup sizeup. Keep native PDN. ACH BTerms stay.
set proto /headless/aravindustries-repos/butterfold/butterfold_proto
set out $proto/physical/results/native_power_ring_ach
set src $out/setup_pre_drt.odb
puts "ROUTE_SRC $src"
...
foreach layer {Metal2 Metal3 Metal4 Metal5} { set_global_routing_layer_adjustment $layer 0.18 }
puts "GRT_SETUP"
global_route -congestion_iterations 80 -verbose -resistance_aware -critical_nets_percentage 25
puts "DRT_SETUP DIODE [diode_count]"
detailed_route -droute_end_iter 64 -or_seed 42 -verbose 1 -output_drc $out/drt/setup_route.drc
...
if {$ant} {
  ...
  ensure_pad_spacing_obs
  detailed_route -droute_end_iter 64 -or_seed 42 -verbose 1 -output_drc $out/drt/setup_route_ant.drc
  remove_pad_spacing_obs
  set ant [check_antennas]
