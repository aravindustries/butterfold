# Incremental GRT+DRT for setup-buffer ECO. Does not destroy existing wires.
set proto /headless/aravindustries-repos/butterfold/butterfold_proto
set out $proto/physical/results/native_power_ring_ach
set src $out/setup_buf_pre_drt.odb
puts "ROUTE_SRC $src"
...
puts "READ_GUIDES $out/setup_buf_combined.guide"
read_guides $out/setup_buf_combined.guide
...
if {$ant} {
  ...
  ensure_pad_spacing_obs
  detailed_route -droute_end_iter 64 -or_seed 42 -verbose 1 -output_drc $out/drt/setup_buf_ant.drc
  remove_pad_spacing_obs
  set ant [check_antennas]
