...
set layout $proto/physical/results/native_power_ring/lvs/butterfold_top.unique_fixed.spice
if {[info exists ::env(LVS_LAYOUT)] && $::env(LVS_LAYOUT) ne ""} {
    set layout $::env(LVS_LAYOUT)
}
set source $proto/physical/results/native_power_ring/butterfold_top.final.pnl.v
if {[info exists ::env(LVS_SOURCE)] && $::env(LVS_SOURCE) ne ""} {
    set source $::env(LVS_SOURCE)
}
set report $proto/physical/results/native_power_ring/lvs/lvs.netgen.rpt
