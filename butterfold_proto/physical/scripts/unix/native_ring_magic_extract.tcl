# Magic device extraction on the native-ring GDS. Reuses the proven LibreLane
# Magic environment; only revision-specific paths are overridden.
set proto /headless/aravindustries-repos/butterfold/butterfold_proto
source $proto/physical/results/m2_fix/lvs/extract/_env.tcl
set ::env(CURRENT_GDS) $proto/physical/results/native_power_ring/candidate/butterfold_top.gds
if {[info exists ::env(FINAL_ACH_GDS)] && $::env(FINAL_ACH_GDS) ne ""} {
    set ::env(CURRENT_GDS) $::env(FINAL_ACH_GDS)
}
set ::env(CURRENT_DEF) $proto/physical/results/native_power_ring/filled.def
if {[info exists ::env(FINAL_ACH_DEF)] && $::env(FINAL_ACH_DEF) ne ""} {
    set ::env(CURRENT_DEF) $::env(FINAL_ACH_DEF)
}
set ::env(STEP_DIR) $proto/physical/results/native_power_ring/lvs/extract
