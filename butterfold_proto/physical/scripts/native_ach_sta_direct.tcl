# Direct OpenRCX extract + slack (no write_spef; avoids STA-1670 on some ODBs).
set proto /headless/aravindustries-repos/butterfold/butterfold_proto
set pdk /foss/pdks/gf180mcuD
set odb $proto/physical/results/native_power_ring_ach/predrt/applied_m3cut_stitched.odb
