# Documented OpenROAD incremental GRT ECO: start_incremental, buffer, end_incremental, DRT.
# Does not destroy existing signal wires or PDN.
...
detailed_route -droute_end_iter 64 -or_seed 42 -verbose 1 -output_drc $out/drt/setup_incr.drc
...
if {$ant} {
  ...
  ensure_pad_spacing_obs
  detailed_route -droute_end_iter 64 -or_seed 42 -verbose 1 -output_drc $out/drt/setup_incr_ant.drc
  remove_pad_spacing_obs
  set ant [check_antennas]
