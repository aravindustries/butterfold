# Targeted antenna diode repair after hold re-route. Do not global-rip.
set proto /headless/aravindustries-repos/butterfold/butterfold_proto
set out $proto/physical/results/native_power_ring
set src $out/hold_routed.odb
...
proc remove_pad_spacing_obs {} {
  ...
  foreach obs $::pad_spacing_obs { odb::dbObstruction_destroy $obs }
  set ::pad_spacing_obs {}
}
proc diode_count {} {
  set n 0
...
set ant [check_antennas -verbose -report_file $out/antenna/pre_repair.rpt]
