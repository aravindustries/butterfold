...
read_db $cand/butterfold_top_co6a27e.odb
...
if {[catch {detailed_route -droute_end_iter 32 -or_seed 42 -verbose 1 -output_drc $eco/co6a27e.drc} dmsg]} {
    puts "DRT_WARN $dmsg"
} else { puts "DRT_OK" }
...
write_spef $cand/co6a27e.max.spef
read_spef $cand/co6a27e.max.spef
...
write_db $cand/butterfold_top_co6a27e_r.odb
write_def $cand/butterfold_top_co6a27e.def
puts "CO6A27E_DONE"
exit
