# Targeted setup ECO13: last -0.09 ns. Third SRAM capture clkbuf_16 + remaining FFs.
set proto /headless/aravindustries-repos/butterfold/butterfold_proto
set pdk /foss/pdks/gf180mcuD
set src $proto/physical/results/d03_ach_candidate/co6a36/setup_eco16/butterfold_top_co6a36_teco12.odb
set outdir $proto/physical/results/d03_ach_candidate/co6a36/setup_eco17
file mkdir $outdir
puts "ECO_SRC $src"
...
proc insert_clk_skew {block db instname pin master bufname} {
  ...
  $buf setOrient R0
  $buf setLocation [expr {$x + 5600}] [expr {$y - 10080}]
...
set nsk 0
incr nsk [insert_clk_skew $block $db u_transform_scheduler_core.u_fft_scratch_sram.u_lo.u_sram CLK $c16 teco13_sk_sram_lo]
incr nsk [insert_clk_skew $block $db u_transform_scheduler_core.u_fft_scratch_sram.u_hi.u_sram CLK $c16 teco13_sk_sram_hi]
foreach ff {_18287_ _18480_ _18288_ _18479_} {
  incr nsk [insert_clk_skew $block $db $ff CLK $c16 teco13_sk_$ff]
}
puts "TECO13_SKEW $nsk"
...
write_db $outdir/butterfold_top_co6a36_teco13.odb
write_def $outdir/butterfold_top_co6a36_teco13.def
puts "TECO13_DONE"
exit
