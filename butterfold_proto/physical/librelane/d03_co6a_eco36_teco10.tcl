# Targeted setup ECO10 from best teco8 (-0.52 ns).
# Second clkbuf_16 on SRAM capture CLK + clkbuf_16 on remaining FF capture CLKs.
set proto /headless/aravindustries-repos/butterfold/butterfold_proto
set pdk /foss/pdks/gf180mcuD
set src $proto/physical/results/d03_ach_candidate/co6a36/setup_eco12/butterfold_top_co6a36_teco8.odb
set outdir $proto/physical/results/d03_ach_candidate/co6a36/setup_eco14
file mkdir $outdir
puts "ECO_SRC $src"
...
proc insert_clk_skew {block db instname pin master bufname} {
  ...
  $buf setOrient R0
  $buf setLocation [expr {$x + 11200}] [expr {$y + 10080}]
  ...
  puts "SKEW $bufname on $instname/$pin"
  return 1
}
...
foreach sram {
  ...
  incr nsk [insert_clk_skew $block $db $sram CLK $c16 teco10_sk_[string map {. _} $sram]]
}
foreach ff {
  _18281_ _18482_ _18475_ _18315_ _18285_ _18478_ _18509_ _18507_ _18510_
  _18287_ _18496_ _18501_ _18491_
} {
  incr nsk [insert_clk_skew $block $db $ff CLK $c16 teco10_sk_$ff]
}
puts "TECO10_SKEW $nsk"
...
write_db $outdir/butterfold_top_co6a36_teco10.odb
write_def $outdir/butterfold_top_co6a36_teco10.def
puts "TECO10_DONE"
exit
