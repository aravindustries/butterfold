# Antenna 2-net cleanup on PG-stitched pg23. All cells FIRM.
...
if {[catch {detailed_route -droute_end_iter 32 -or_seed 42 -verbose 1 -output_drc $eco/ant24.drc} dmsg]} {
  puts "DRT_WARN $dmsg"
} else { puts "DRT_OK" }
puts "ANT_AFTER"
catch {check_antennas -report_file $out/ant24.rpt}
write_db $eco/butterfold_top_ant24.odb
