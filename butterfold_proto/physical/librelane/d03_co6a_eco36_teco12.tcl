# Targeted setup ECO12: last 8 endpoints, WNS -0.32 TNS -2.07.
set proto /headless/aravindustries-repos/butterfold/butterfold_proto
set pdk /foss/pdks/gf180mcuD
set src $proto/physical/results/d03_ach_candidate/co6a36/setup_eco15/butterfold_top_co6a36_teco11.odb
set outdir $proto/physical/results/d03_ach_candidate/co6a36/setup_eco16
file mkdir $outdir
puts "ECO_SRC $src"
...
set nsk 0
foreach ff {_18467_ _18193_ _18470_ _18197_ _18199_ _18211_ _18277_ _18387_} {
  incr nsk [insert_clk_skew $block $db $ff CLK $c16 teco12_sk_$ff]
}
puts "TECO12_SKEW $nsk"
...
write_db $outdir/butterfold_top_co6a36_teco12.odb
write_def $outdir/butterfold_top_co6a36_teco12.def
puts "TECO12_DONE"
exit
