# Targeted setup ECO3 from teco2 (DRT_OK, R180 preserved).
# New WNS class: _18568_ dft12_base[3] high-fanout control
#   (_11091_ FO=27 5.75ns, _11254_ aoi221_1 8.52ns).
# Also remaining 21 dlya/dlyb and the _18692_ prefix _09473_ oai211_1.
# NO repair_design. Do not touch the nine aoi221_2 R180. Do not add aoi221_2.
set proto /headless/aravindustries-repos/butterfold/butterfold_proto
set pdk /foss/pdks/gf180mcuD
set src $proto/physical/results/d03_ach_candidate/co6a36/setup_eco6/butterfold_top_co6a36_teco2.odb
set outdir $proto/physical/results/d03_ach_candidate/co6a36/setup_eco7
file mkdir $outdir
puts "ECO_SRC $src"
...
proc eco_insert_buf {block db instname pin mastername bufname} {
  ...
  if {$iterm eq "NULL" || $iterm eq ""} { puts "NOPIN $instname/$pin"; return 0 }
...
set nswap 0
set pairs {
  _18568_  gf180mcu_fd_sc_mcu9t5v0__dffrnq_4
  _09099_  gf180mcu_fd_sc_mcu9t5v0__clkinv_8
  _10019_  gf180mcu_fd_sc_mcu9t5v0__nand2_4
  _11088_  gf180mcu_fd_sc_mcu9t5v0__nor2_4
  _11091_  gf180mcu_fd_sc_mcu9t5v0__aoi21_4
  _11253_  gf180mcu_fd_sc_mcu9t5v0__aoi21_4
  _11254_  gf180mcu_fd_sc_mcu9t5v0__aoi221_4
  _11255_  gf180mcu_fd_sc_mcu9t5v0__oai221_2
  _11257_  gf180mcu_fd_sc_mcu9t5v0__nand2_4
  _19083_  gf180mcu_fd_sc_mcu9t5v0__dffrnq_4
  max_cap150 gf180mcu_fd_sc_mcu9t5v0__clkbuf_16
  _09473_  gf180mcu_fd_sc_mcu9t5v0__oai211_4
  _18692_  gf180mcu_fd_sc_mcu9t5v0__dffrnq_4
  clone345 gf180mcu_fd_sc_mcu9t5v0__nand4_4
  _16621_  gf180mcu_fd_sc_mcu9t5v0__oai21_4
  _16620_  gf180mcu_fd_sc_mcu9t5v0__nand4_4
  _16694_  gf180mcu_fd_sc_mcu9t5v0__nand3_4
  _09506_  gf180mcu_fd_sc_mcu9t5v0__aoi21_4
  _15940_  gf180mcu_fd_sc_mcu9t5v0__oai21_4
  clone234 gf180mcu_fd_sc_mcu9t5v0__oai31_4
  _15943_  gf180mcu_fd_sc_mcu9t5v0__or2_4
}
foreach {inst tgt} $pairs {
  incr nswap [eco_swap $block $db $inst $tgt]
}

# Remaining hold-delay cells on data (21 total). clkbuf_4, same I/Z pins.
set ndly 0
foreach inst [$block getInsts] {
  set mn [[$inst getMaster] getName]
  if {[string match *dlya_* $mn] || [string match *dlyb_* $mn]} {
    incr ndly [eco_swap $block $db [$inst getName] gf180mcu_fd_sc_mcu9t5v0__clkbuf_4]
  }
}
puts "DELAY_SWAPPED $ndly"

set nbuf 0
set c16 gf180mcu_fd_sc_mcu9t5v0__clkbuf_16
incr nbuf [eco_insert_buf $block $db _18568_ Q $c16 teco3_buf_18568]
incr nbuf [eco_insert_buf $block $db _11091_ ZN $c16 teco3_buf_11091]
incr nbuf [eco_insert_buf $block $db _11254_ ZN $c16 teco3_buf_11254]
incr nbuf [eco_insert_buf $block $db _11088_ ZN $c16 teco3_buf_11088]
puts "TECO3_SWAPPED $nswap BUF $nbuf"
...
# Nudge known endcap-overlap cells inward by 10 sites (5.6 um).
foreach name {_09310_ _09437_ _09438_} {
...
write_db $outdir/butterfold_top_co6a36_teco3.odb
write_def $outdir/butterfold_top_co6a36_teco3.def
puts "TECO3_DONE"
exit
