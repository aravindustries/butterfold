...
read_db $cand/butterfold_top_co6a27f.odb
...
if {[catch {detailed_route -droute_end_iter 32 -or_seed 42 -verbose 1 -output_drc $eco/co6a27f.drc} dmsg]} {
    puts "DRT_WARN $dmsg"
} else { puts "DRT_OK" }
...
write_spef $cand/co6a27f.max.spef
read_spef $cand/co6a27f.max.spef
...
write_db $cand/butterfold_top_co6a27f_r.odb
write_def $cand/butterfold_top_co6a27f.def
puts "CO6A27E_DONE"
exit
