# Distributed-source IR on the pgfix ODB (VSS west-margin stitch).
...
read_spef -corner $c $cand/filled.max.spef
...
analyze_power_grid -net VDD -source_type FULL -voltage_file $cand/irdrop/net-VDD-pgfix-full.csv
puts "IRDROP_VSS_FULL"
analyze_power_grid -net VSS -source_type FULL -voltage_file $cand/irdrop/net-VSS-pgfix-full.csv
if {[file exists $cand/irdrop/VDD.ach.csv.vsrc]} {
    puts "IRDROP_VDD_ACH_VSRC"
    analyze_power_grid -net VDD -vsrc $cand/irdrop/VDD.ach.csv.vsrc -voltage_file $cand/irdrop/net-VDD-pgfix-vsrc.csv
    puts "IRDROP_VSS_ACH_VSRC"
    analyze_power_grid -net VSS -vsrc $cand/irdrop/VSS.ach.csv.vsrc -voltage_file $cand/irdrop/net-VSS-pgfix-vsrc.csv
}
puts "IR_PGFIX_DONE"
exit
