set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-35-52/13-openroad-floorplan/config.tracks
...
set ::env(DESIGN_NAME) standalone_result_serializer
set ::env(CLOCK_PERIOD) 10
set ::env(CLOCK_PORT) clk
set ::env(VDD_NETS) VDD
set ::env(GND_NETS) VSS
set ::env(DIE_AREA) "0.0 0.0 1300.0 1000.0"
set ::env(FALLBACK_SDC) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/standalone_result_serializer.sdc
...
set ::env(CURRENT_NL) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-35-52/06-yosys-synthesis/standalone_result_serializer.nl.v
set ::env(SAVE_ODB) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-35-52/13-openroad-floorplan/standalone_result_serializer.odb
set ::env(SAVE_DEF) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-35-52/13-openroad-floorplan/standalone_result_serializer.def
set ::env(SAVE_SDC) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-35-52/13-openroad-floorplan/standalone_result_serializer.sdc
set ::env(SAVE_NL) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-35-52/13-openroad-floorplan/standalone_result_serializer.nl.v
set ::env(SAVE_PNL) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-35-52/13-openroad-floorplan/standalone_result_serializer.pnl.v
