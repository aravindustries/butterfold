...
set ::env(CURRENT_ODB) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/41-odb-diodesonports/1-odb-portdiodeplacement/standalone_result_serializer.odb
set ::env(SAVE_ODB) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/41-odb-diodesonports/2-openroad-detailedplacement/standalone_result_serializer.odb
set ::env(SAVE_DEF) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/41-odb-diodesonports/2-openroad-detailedplacement/standalone_result_serializer.def
set ::env(SAVE_SDC) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/41-odb-diodesonports/2-openroad-detailedplacement/standalone_result_serializer.sdc
set ::env(SAVE_NL) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/41-odb-diodesonports/2-openroad-detailedplacement/standalone_result_serializer.nl.v
set ::env(SAVE_PNL) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/41-odb-diodesonports/2-openroad-detailedplacement/standalone_result_serializer.pnl.v
