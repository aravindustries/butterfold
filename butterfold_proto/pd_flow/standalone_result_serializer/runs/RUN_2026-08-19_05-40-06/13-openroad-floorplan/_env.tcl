set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NL) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/06-yosys-synthesis/standalone_result_serializer.nl.v
set ::env(SAVE_ODB) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/13-openroad-floorplan/standalone_result_serializer.odb
set ::env(SAVE_DEF) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/13-openroad-floorplan/standalone_result_serializer.def
set ::env(SAVE_SDC) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/13-openroad-floorplan/standalone_result_serializer.sdc
set ::env(SAVE_NL) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/13-openroad-floorplan/standalone_result_serializer.nl.v
set ::env(SAVE_PNL) /foss/designs/butterfold/butterfold_proto/pd_flow/standalone_result_serializer/runs/RUN_2026-08-19_05-40-06/13-openroad-floorplan/standalone_result_serializer.pnl.v
