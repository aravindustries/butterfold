set ::env(TRACKS_INFO_FILE_PROCESSED) /foss/designs/butterfold/butterfold_proto/pd_flow/butterfly_top_controller/runs/RUN_2026-08-20_05-19-04/13-openroad-floorplan/config.tracks
...
set ::env(DESIGN_NAME) butterfold_top_control
set ::env(CLOCK_PERIOD) 10
set ::env(CLOCK_PORT) clk
set ::env(VDD_NETS) VDD
set ::env(GND_NETS) VSS
set ::env(DIE_AREA) "0.0 0.0 1300.0 1000.0"
set ::env(FALLBACK_SDC) /foss/designs/butterfold/butterfold_proto/pd_flow/butterfly_top_controller/butterfold_top_controller.sdc
...
set ::env(CURRENT_NL) /foss/designs/butterfold/butterfold_proto/pd_flow/butterfly_top_controller/runs/RUN_2026-08-20_05-19-04/06-yosys-synthesis/butterfold_top_control.nl.v
set ::env(SAVE_ODB) /foss/designs/butterfold/butterfold_proto/pd_flow/butterfly_top_controller/runs/RUN_2026-08-20_05-19-04/13-openroad-floorplan/butterfold_top_control.odb
set ::env(SAVE_DEF) /foss/designs/butterfold/butterfold_proto/pd_flow/butterfly_top_controller/runs/RUN_2026-08-20_05-19-04/13-openroad-floorplan/butterfold_top_control.def
set ::env(SAVE_SDC) /foss/designs/butterfold/butterfold_proto/pd_flow/butterfly_top_controller/runs/RUN_2026-08-20_05-19-04/13-openroad-floorplan/butterfold_top_control.sdc
set ::env(SAVE_NL) /foss/designs/butterfold/butterfold_proto/pd_flow/butterfly_top_controller/runs/RUN_2026-08-20_05-19-04/13-openroad-floorplan/butterfold_top_control.nl.v
set ::env(SAVE_PNL) /foss/designs/butterfold/butterfold_proto/pd_flow/butterfly_top_controller/runs/RUN_2026-08-20_05-19-04/13-openroad-floorplan/butterfold_top_control.pnl.v
